...
data1,data2,data3 =loop_data(r'D:\vs项目\Tikhonov_Regularization\比较数据\result31.txt')
data11,data22,data33 =loop_data(r'D:\vs项目\Tikhonov_Regularization\比较数据\result41.txt')
...
plt.savefig("D:\Paper\Paper_2\Fig4.png")
plt.show()

fig, (ax1, ax2, ax3) = plt.subplots(3, 1, figsize=(8, 5),dpi=200)

data1,data2,data3 =loop_data(r'D:\vs项目\Tikhonov_Regularization\比较数据\result32.txt')
data11,data22,data33 =loop_data(r'D:\vs项目\Tikhonov_Regularization\比较数据\result42.txt')
...
plt.savefig("D:\Paper\Paper_2\Fig5.png")
plt.show()

fig, (ax1, ax2, ax3) = plt.subplots(3, 1, figsize=(8, 5),dpi=200)
data1,data2,data3 =loop_data(r'D:\vs项目\Tikhonov_Regularization\比较数据\result33.txt')
data11,data22,data33 =loop_data(r'D:\vs项目\Tikhonov_Regularization\比较数据\result43.txt')
...
plt.savefig("D:\Paper\Paper_2\Fig6.png")
plt.show()